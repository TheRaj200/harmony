      ...
      <div className='absolute top-100 md:top-65 xl:top-85 2xl:top-110 flex md:flex-row flex-col justify-center w-full gap-8 mt-12'>
        ...
        <div className='relative flex  items-center justify-center'>
          <img
            ...
            className={`absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[380px] max-w-[90vw] z-0 rotate-12 pointer-events-none select-none transition-transform duration-500 ${bgScale ? 'scale-100' : 'scale-0'}`}
          />
          <ThreeDImage
            src="./images/c2.png"
            alt="Chocolate Bar 1"
        ...
        {/* Nut1 with Nut2 background and 3D effect */}
        <div className="relative flex items-center justify-center">
          <motion.img
            src="./images/nut2.png"
            alt="Nut Background"
        ...
        {/* Berry1 with Berry2 background and 3D effect */}
        <div className="relative flex items-center justify-center">
          <motion.img
        ...
        {/* Bar1 with Bar2 background and 3D effect */}
        <div className="relative flex items-center justify-center">
          <motion.img
            src="./images/c3.png"
            alt="Bar Background"
