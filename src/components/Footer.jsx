...
// Quick link item component with animation
...
// Social media item component with animation
        ...
        <div className="max-w-5xl w-full px-6 flex flex-col items-center relative z-10">
          ...
          >
            ...
            <div className="flex-1 min-w-[220px] flex flex-col items-center md:items-start text-center md:text-left">
              ...
              >
                Indulge in the finest chocolate creations, crafted with passion and the highest quality ingredients.
              </motion.p>
              <motion.div 
              ...
              >
                {['Instagram', 'Facebook', 'Youtube', 'x'].map((platform, idx) => (
                  <motion.a 
                    key={platform}
            ...
            <div className="flex-1 min-w-[220px] flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <ul className="space-y-4 flex flex-col gap-2 text-white/70">
                {['About Us', 'Contact Us', 'Track your order', 'FAQs', 'Privacy Policy'].map((text, idx) => (
          ...
          >
            ...
            >
              ...
              <motion.button 
                whileHover={{ scale: 1.05, boxShadow: '0 10px 25px -5px rgba(50, 192, 194, 0.4)' }}
                whileTap={{ scale: 0.95 }}
          ...
          >
            ...
            <div className="flex gap-6">
              <a href="#" className="hover:text-white/80 transition-colors duration-300">Terms</a>
              <a href="#" className="hover:text-white/80 transition-colors duration-300">Privacy</a>
              <a href="#" className="hover:text-white/80 transition-colors duration-300">Cookies</a>
            </div>
          </motion.div>
        </div>
      </div>
