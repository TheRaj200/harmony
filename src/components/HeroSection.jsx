...
const HeroSection = () => {
  ...
  useEffect(() => {
    ...
    c2Controls,
    c8LeftTopControls,
    c8LeftCenterControls,
    c8RightCenterControls,
    c8RightTopControls,
  ]);
  ...
  return (
    <section>
      ...
      <div
        className="flex flex-col items-center justify-center h-screen cursor-grab select-none relative"
      ...
      >
        <motion.img
          ...
          style={{
            pointerEvents: "none",
            scale: useTransform(scrollYProgressReverse, [0, 0.3], [0, 0.3]),
