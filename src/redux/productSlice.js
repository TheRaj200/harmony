    ...
    accordionData: [
      {
        title: "Ingredients",
        content:
          "Milk Solids (22%), Rabri Essence, Elachi, Sugar, Permitted Emulsifiers (E322, E476), Added Natural and Artificial Flavoring Substances - Vanilla",
      },
      {
    ...
    accordionData: [
      {
        title: "Ingredients",
        content:
          "Cocoa Solids, Sugar, Fox Nuts, Milk Solids (22%), Cocoa Butter, Permitted Emulsifiers (INS 422, INS 476), Added Cocoa and Vanilla Flavors",
      },
      {
        title: "Allergen Information",
        content: "Contains Milk & Soy (Lecithin of Soya origin)",
    ...
    accordionData: [
      {
        title: "Ingredients",
        content:
          "Cocoa Solids, Dehydrated Fruits, Sugar, Milk Solids (22%), Permitted Emulsifiers (422,476), Added Cocoa and Vanilla Flavors",
      },
      {
        title: "Allergen Information",
        content: "Contains Milk & Soy (Lecithin of Soya origin)",
    ...
    accordionData: [
      {
        title: "Ingredients",
        content:
          "Cocoa Solids, Sugar, Rice Krispies, Salt, Natural Vanilla Flavor, Permitted Emulsifiers (INS 422, INS 476), Added Cocoa and Vanilla Flavors",
      },
      {
        title: "Allergen Information",
        content: "Contains Milk & Soy (Lecithin of Soya origin)",
    ...
    accordionData: [
      {
        title: "Ingredients",
        content:
          "Foxnuts (Makhana), Olive Oil, Spices & Condiments (Red Chilli, Dried Garlic, Dried Onion, Cumin, Dried Mango Powder, Mint leaves, Dried Ginger, Clove, Cinnamon, Black Pepper, Nutmeg), Iodised Salt, Sugar, Acidifying Agent (Citric Acid)",
      },
      {
        title: "Allergen Information",
        content:
          "Contains Tree Nuts. This product has been packed in an integrated nuts & dried fruits processing unit and may contain an occasional trace of other nuts or dried fruits",
      },
      {
        title: "Net Weight",
        content: "85g (approx)",
    ...
    accordionData: [
      {
        title: "Ingredients",
        content:
          "Foxnuts (Makhana), Olive Oil, Spices & Condiments (Yellow Chilli, Onion, Parsley, Cheese, Salt, Sugar, Acidifying Agent (Malic Acid))",
      },
      {
        title: "Allergen Information",
        content:
    ...
    accordionData: [
      {
        title: "Ingredients",
        content:
          "Foxnuts (Makhana), Olive Oil, Spices & Condiments (Red Chilli, Dried Garlic, Dried Onion, Cumin, Dried Mango Powder, Coriander seeds, Dried Ginger, Turmeric, Carom Seeds, Black Pepper, Cinnamon, Fenugreek Seeds, Nutmeg, Mace), Acidifying Agent (Citric Acid), Colour (Paprika Extract), Flavour Enhancer (INS 635)",
      },
      {
        title: "Allergen Information",
        content:
...
export const productSlice = createSlice({
  ...
  reducers: {
    ...
    setSelectedProduct: (state, action) => {
      ...
      // Find product
      const product =
        state.productShowcase.find((p) => p.id === productId) ||
...
export const { setProductHover, setSelectedProduct, resetSelectedProduct } =
