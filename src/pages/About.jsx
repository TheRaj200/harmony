      ...
      <div className="   px-4 md:px-8 lg:px-16 ">
        <div className="mx-auto translate-y-40">
          ...
          <div className="flex flex-col md:flex-row justify-center !mt-10 items-center gap-12 md:mb-20">
            <img
              className="h-90 md:h-140 rounded-2xl"
            ...
            >
              ...
              <p className="text-blue-100 h-50 !mt-10 leading-relaxed">
                Aayush Sapra, a culinary connoisseur with an insatiable love for
                all things food, has always believed that the best experiences
                are shared. His popular YouTube channel, known for its
                captivating food adventures and challenges, has garnered a
                massive following. However, Aayush's passion for chocolate led
                him to embark on a new and exciting venture.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className=" mx-auto">
          ...
          <div className="flex justify-center items-center flex-col md:flex-row !mt-20  gap-8">
            ...
            <div className="bg-gradient-to-br from-pink-700/20 to-pink-800 !p-8 rounded-xl shadow-xl transform transition-all duration-500 hover:scale-105 opacity-0 animate-fadeIn delay-100  hover:shadow-pink-500/20 backdrop-blur-md fade-animate-card">
              ...
              <div className="mb-6  !p-4 rounded-lg border-l-4 border-pink-500">
                <p className="text-blue-100 italic leading-relaxed">
                  "The flavors in Harmony Chocolates are unlike anything I've
                  ever experienced. Each bite tells a story and takes you on a
                  journey. The dark chocolate with sea salt is my absolute
                  favorite – it's the perfect balance of sweet and savory.
                  Absolutely divine!"
                </p>
              </div>
            ...
            <div className="bg-gradient-to-br from-pink-700/20 to-pink-800 !p-8 rounded-xl shadow-xl transform transition-all duration-500 hover:scale-105 opacity-0 animate-fadeIn delay-300  hover:shadow-pink-500/20 backdrop-blur-md fade-animate-card">
              ...
              <div className="mb-6  !p-4 rounded-lg border-l-4 border-pink-500">
                <p className="text-blue-100 italic leading-relaxed">
                  "As a food critic, I've tasted chocolates from around the
                  world, but Harmony Chocolates stands in a league of its own.
                  The attention to flavor profiles and texture is remarkable.
                  The praline collection showcases Aayush's understanding of
                  balance and craftsmanship. A true masterpiece."
                </p>
              </div>
              <div className="flex !mt-4 text-pink-500">
                <span className="text-xl">★</span>
            ...
            <div className="bg-gradient-to-br from-pink-700/20 to-pink-800 !p-8 rounded-xl shadow-xl transform transition-all duration-500 hover:scale-105 opacity-0 animate-fadeIn delay-500 hover:shadow-pink-500/20 backdrop-blur-md fade-animate-card">
              ...
              <div className="mb-6  !p-4 rounded-lg border-l-4 border-pink-500">
                <p className="text-blue-100 italic leading-relaxed">
                  "As a pastry chef, I'm extremely particular about the
                  chocolate I use. Harmony Chocolates has become my go-to for
                  both professional and personal indulgence. The quality and
                  consistency are unmatched, and they elevate even my simplest
                  pastries."
                </p>
              </div>
              <div className="flex !mt-4 text-pink-500">
